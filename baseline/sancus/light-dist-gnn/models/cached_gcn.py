...
#                    'BackwardL1': False, 'BackwardL2': False }
g_cache_enabled = {'ForwardL1': True, 'ForwardL2': True, 'ForwardL3': True, 'ForwardL4': True,'ForwardL5': True,'ForwardL6': True,'ForwardL7': True,'ForwardL8': True,
                   'BackwardL1': False, 'BackwardL2': False, 'BackwardL3': False, 'BackwardL4': False, 'BackwardL5': False, 'BackwardL6': False, 'BackwardL7': False, 'BackwardL8': False }
# g_cache_enabled = {'ForwardL1': False, 'ForwardL2': False,
#                    'BackwardL1': False, 'BackwardL2': False }
...
class CachedGCN(nn.Module):
    def __init__(self, g, env, hidden_dim=16):
        ...
        self.weight3 = nn.Parameter(torch.rand(hidden_dim, hidden_dim).to(env.device))
        self.weight4 = nn.Parameter(torch.rand(hidden_dim, out_dim).to(env.device))
    ...
    def forward(self, features):
        ...
        hidden_features = F.relu(DistGCNLayer.apply(hidden_features, self.weight3, self.g.adj_parts, 'L3'))
        outputs = DistGCNLayer.apply(hidden_features, self.weight4, self.g.adj_parts,  'L4')
        return outputs
